...
* **ci:** pin semver tag in docker-compose.yaml after each release ([614bcab](https://github.com/slmingol/uptime-kuma-pfsense-sync/commit/614bcabbca68405e685675999c5c472f8e1b059f))
...
## <small>1.9.9 (2026-07-25)</small>

* fix(ui): header title 1.25em, meta/status/btn 1em off 16px base, height 52px ([4571924](https://github.com/slmingol/uptime-kuma-pfsense-sync/commit/4571924))
...
## <small>1.8.6 (2026-07-25)</small>

* fix(ui): increase base font size to 56px (2x) ([665f509](https://github.com/slmingol/uptime-kuma-pfsense-sync/commit/665f509))
