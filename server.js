...
.sec-title{font-size:1.02rem;font-weight:bold;color:var(--tx)}
.badge{font-size:.85rem;padding:2px 9px;border-radius:10px;white-space:nowrap;font-variant-numeric:tabular-nums}
...
th{padding:7px 16px;text-align:left;color:var(--tx-dim);border-bottom:1px solid var(--border);font-weight:normal;font-size:.88rem;text-transform:uppercase;letter-spacing:.1em}
td{padding:9px 16px;border-bottom:1px solid var(--border)}
tr:last-child td{border-bottom:none}
tr:hover td{background:var(--hover)}
.b{font-weight:bold}
.saddr{color:var(--tx-muted);font-size:.90rem}

/* inline badge */
.ibadge{display:inline-block;padding:1px 6px;border-radius:3px;font-size:.85rem;font-weight:bold;letter-spacing:.02em}
...
.empty{padding:32px;text-align:center;color:var(--tx-muted);font-size:.95rem}
  ...
  <div class="sec">
    <div class="sec-hdr">
      ...
      <div style="display:flex;align-items:center;gap:10px">
        ...
        <button class="btn" id="toggle-btn" onclick="toggleInventory()" style="font-size:.85rem;padding:3px 10px">Show all</button>
      </div>
    </div>
  ...
  <div class="sec">
    <div class="sec-hdr">
      ...
      <div style="display:flex;align-items:center;gap:10px">
        ...
        <button class="btn" id="um-toggle-btn" onclick="toggleUm()" style="font-size:.85rem;padding:3px 10px">Show all</button>
      </div>
    </div>
  ...
  <div class="sec">
    <div class="sec-hdr">
      ...
      <div style="display:flex;align-items:center;gap:10px">
        ...
        <button class="btn" id="hap-toggle-btn" onclick="toggleHap()" style="font-size:.85rem;padding:3px 10px">Show all</button>
      </div>
    </div>
