...
/* header */
.hdr{background:var(--surface);border-bottom:1px solid var(--border);padding:0 24px;height:88px;display:flex;align-items:center;justify-content:space-between;gap:16px;line-height:1.2}
.hdr-title{font-size:36px;font-weight:bold;color:var(--tx);letter-spacing:.04em}
.hdr-title span{color:var(--accent)}
.hdr-meta{font-size:26px;color:var(--tx-muted);margin-top:2px}
...
.status-label{font-size:26px;color:var(--tx-muted)}
@keyframes blink{0%,100%{opacity:1}50%{opacity:.25}}

/* run button */
.btn{background:var(--accent);color:#071420;border:none;padding:5px 14px;border-radius:4px;cursor:pointer;font-family:inherit;font-size:26px;font-weight:bold;line-height:1.4;letter-spacing:.02em}
...
.legend-label{font-size:1rem;text-transform:uppercase;letter-spacing:.1em;color:var(--tx-dim);margin-bottom:10px}
.legend-item{font-size:1.15rem;color:var(--tx-muted);padding:3px 0;display:flex;align-items:center;gap:7px}
